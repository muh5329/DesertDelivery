...
func setup(p_bike: Bike, p_player: Player, p_cam: ChaseCamera, p_gun: GunSystem, p_world: WorldManager, p_controls: Controls.Source) -> void:
	bike = p_bike; player = p_player; cam = p_cam; gun = p_gun; world = p_world
...
func save_state() -> Dictionary:
	return {"mode": mode, "player_pos": player.global_position, "player_forward": player.flat_forward()}
